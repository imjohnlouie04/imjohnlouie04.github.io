    ...
    activities: [
      {
        ...
        description: [
          {
            text: 'Solve the problem for provincial bus traveler to book online instead of queing on the bus station'
          },
          {
      ...
      },
      {
        ...
        description: [
          {
            text: 'Provide solution for the mentors and mentees to meet and talk and share their experience'
          }
        ]
      }
    ],
